...
public class Assertions_inTestNG {
	...
	// Assert is a class which has a lot of methods that can help us in Assertions
	// or Validations
	...
	public void logout() {
		...
		Assert.assertTrue(actualLogoutMessage.contains(expectedLogoutMessage)); // either one works
	}
