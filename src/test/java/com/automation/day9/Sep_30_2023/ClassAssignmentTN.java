...
public class ClassAssignmentTN {
	...
	public void checkingEqualsMethod() {
		...
		String actualModifyYourAddressBookEntriesLink = driver
				.findElement(By.linkText("Modify your address book entries")).getText();
		...
		if (actualLogoutLink.equals(expectedLogoutLink)) {
